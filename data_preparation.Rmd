...
The `all_temp` dataframe was then grouped by `data_years` and `borough`, and the `avg_temperature` variable was calculated as the mean of the `temperature_2m_mean_c` values.
