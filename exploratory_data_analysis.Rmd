...
Make a heat map showing differences across UHF42 neighborhoods from 2016-2018 to 2019-2021. 
```{r}
...
```
Looking at the PM2.5(ug/m3) levels across the two time periods(2016-2018 and 2019-2021), we can observe several key patterns:
- Overall, there is a general decrease in PM2.5 levels from 2016-2018 and 2019-2021 across the majority of UHF42 neighborhoods, as the 2019-2021 map has much darkers colors indicating lower PM2.5 levels. 
- Midtown Manhattan shows the highest PM2.5 levels across both time periods.
- Staten Island shows the lowest PM2.5 levels across all boroughs. 

We hypothesize that the COVID-19 pandemic resulted in significantly reduced traffic and industrial pollution, resulting in lower PM2.5 levels in 2019-2021 compared to 2016-2018. 
