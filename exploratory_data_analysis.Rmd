...
ggplot(total_acres, aes(x = reorder(borough, acres_sum), y = acres_sum, fill = year_group)) + 
  ...
  labs(x = "Borough", y = "Greenspace (Total Acres)", title = "Greenspaces Across Borough by Time Period") +
  theme_minimal()
...
binded |> 
  ...
  labs(x = "Greenspace Types", y = "Total Acres", title = "Total Acres of NYC Greenspace by Type and Time Period") +
    theme_minimal() +
