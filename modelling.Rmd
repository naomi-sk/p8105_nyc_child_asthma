...
Compared to the Bronx, Queens shows the largest reduction in ED visits (-169.36 visits, p < 0.001), followed by Brooklyn (-158.44 visits, p < 0.001) and Staten Island (-113.01 visits, p = 0.001). Manhattan's lower rate (-37.83 visits) was not statistically significant (p = 0.122).
...
The scatter plots show consistent positive relationships between Heat Vulnerability Index and both pediatric asthma health outcomes across time periods. ED visit rates show a stronger association with HVI than hospitalization rates, as observed in steeper trend lines. 

The relationship appears more pronounced in the 2016-2018 period, with ED visits ranging from approximately 50 to 300 per 10,000 across HVI scores. While the overall patterns persist in 2019-2021, the rates are lower, particularly for ED visits. The considerable vertical spread in the data points at each HVI level would likely suggest that other factors outside of heat vulnerability have an effect on pediatric asthma health outcomes.
