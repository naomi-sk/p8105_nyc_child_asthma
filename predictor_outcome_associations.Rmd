...
#### Temperature vs ED visits by year group
...
# Plot the data and regression lines
tempplot = ggplot(temp_association_ed, aes(x = avg_temperature, y = borough_rate, group = data_years)) + 
  geom_point(aes(color = data_years)) + 
  geom_smooth(method = "lm", aes(color = data_years, group = data_years), se = FALSE, linetype = "solid") +
  theme_minimal() +
...
For both year groups, there is nearly no correlation between temperature and ED visit rate. We can infer that temperature is not a significant factor for ED visits.

#### Temperature vs Hospitalization by year group
...
# Plot the data and regression lines
tempplot2 = ggplot(temp_association_hosp, aes(x = avg_temperature, y = borough_rate, group = data_years)) + 
  geom_point(aes(color = data_years)) + 
  geom_smooth(method = "lm", aes(color = data_years, group = data_years), se = FALSE, linetype = "solid") +
  theme_minimal() +
...
For both year groups, there is nearly no correlation between temperature and Hospitalization rate. We can infer that temperature is not a significant factor for Hospitalization.

#### Plot of average temperature vs rate by borough
