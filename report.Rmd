...
**Figure 9. PM2.5 Levels and ED Visits Rate by Year Group**
...
**Table 9. Correlation between PM2.5 Levels and ED Visits Rate by Year Group**
...
**Figure 10. Year Group Comparison: PM2.5 Levels and Hospitalization Rate**
...
**Table 10. Correlation between PM2.5 Levels and Hospitalization Rate by Year Group**
...
**Figure 11. PM2.5 Levels and Outcome across Borough and by Year Group**
...
EDplot
```
**Figure 12. Greenspace and ED Visits Rate by Year Group**

```{r}
#Make table of results
knitr::kable(EDmodels, digits = 3)
```
**Table 11. Correlation between Greenspace and ED Visit Rate by Year Group**
...
hosplot
```
**Figure 13. Greenspace and Hospitalization Rate by Year Group**

```{r}
 #Make table of results
knitr::kable(hospmodels, digits = 3)
```
**Table 12. Correlation between Greenspace and Hospitalization Rate by Year Group**
...
combo1
```
**Figure 14. Greenspace and Outcome across Borough and by Year Group**
...
**Figure 15. Temperature and ED Visits Rate by Year Group**

```{r}
knitr::kable(tempmodel, digits = 3)
```
**Table 13. Correlation between Temperature and ED Visits Rate by Year Group**
...
tempplot2
```
**Figure 16. Temperature and Hospitalization Rate by Year Group**

```{r}
knitr::kable(tempmodel2, digits = 3)
```

**Table 14. Correlation between Temperature and Hospitalization Rate by Year Group**
...
ggplot(temp_association, aes(x = avg_temperature, y = borough_rate, color = Borough)) +
  ...
  theme_minimal()
```
**Figure 17. Temperature and Outcomes across Borough and by Year Group**
...
```
**Figure 18. Associations between HVI and Outcomes**
...
```
**Table 15. Statistical Results for ED Visits (2016-2018)**
...
**Table 16. Statistical Results for ED Visits (2019-2021)**
...
**Table 16. Statistical Results for Hospitalizations (2016-2018)**
...
```
**Table 17. Statistical Results for Hospitalizations (2019-2021)**
...
```
**Table 18. Statistical Table for Model Diagnostics**
